        ...
        Expanded(
          child: InkWell(
            ...
            child: AllExpansesItem(
              ...
              allExpansesItemModel: AllExpansesItemListView.allExpansesItemModelList[0],
          ),
        ),
        ),
        SizedBox(width: 6,),
        Expanded(
          child: InkWell(
            ...
            child: AllExpansesItem(
              ...
              allExpansesItemModel: AllExpansesItemListView.allExpansesItemModelList[1],
          ),
        ),
        ),
        SizedBox(width: 6,),
        Expanded(
          child: InkWell(
            ...
            child: AllExpansesItem(
              ...
              allExpansesItemModel: AllExpansesItemListView.allExpansesItemModelList[2],
          ),
        ),
        ),
...
//     return Row(
//       children: AllExpansesItemListView.allExpansesItemModelList
//           .asMap()
//           .entries
//           .map((e) {
//         int index = e.key;
